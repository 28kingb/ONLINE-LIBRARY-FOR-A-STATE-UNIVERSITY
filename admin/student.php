...
<h2><br>List Of Students</h2>
<?php

		if(isset($_POST['submit']))
		{
			$q=mysqli_query($db,"SELECT first,last,dob,username,email,contact,address,gender FROM `student` where username like '%$_POST[search]%' ");
		...
		{
			$res=mysqli_query($db,"SELECT first,last,dob,username,email,contact,address,gender FROM `student` ORDER BY `student`.`first` ASC;");
