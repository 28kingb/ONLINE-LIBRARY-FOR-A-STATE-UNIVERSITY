...
<!--php coding-->
            ...
            if(isset($_POST['submit']))
            {
              ...
              if($count==0)
              {mysqli_query($db,"INSERT INTO `STUDENT` VALUES('$_POST[first]','$_POST[last]','$_POST[dob]','$_POST[username]','$_POST[email]','$_POST[contact]','$_POST[address]','$_POST[gender]','$_POST[type]','$_POST[password]');");
            }
             ?>
